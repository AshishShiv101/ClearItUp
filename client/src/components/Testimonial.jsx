...
const Testimonial = () => {
  return (
    <div>
          <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 bg-clip-text text-transparent py-5'>Customer Testimonials</h1>
